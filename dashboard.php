  ...
  <body>
    ...
    color: #303030;">Cherry</b><br><b style="color:rgba(172, 4, 46, 0.79);">"Where Quality and taste are known Best."</b></div>
      ...
      <div class="max-w-[1390px] mx-auto">
                  ...
                  <div class="row">
                      <form class="row g-3 needs-validation" action="" method="post" enctype="multipart/form-data">
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" name="pn" id="validationCustom01" required placeholder="Enter Product Name">
                              <div class="valid-feedback">
                                  Looks good!
                              </div>
                          </div>
                          <div class="col-md-6">
                              <label for="validationCustom02" class="form-label">Price Name :</label>
                              <input type="text" class="form-control" name="prn" id="validationCustom02" placeholder="Enter Price Name" required>
                              <div class="valid-feedback">
                          ...
                          <div class="col-md-6">
                              ...
                              <input type="file" class="form-control" name="image" id="validationCustom02" placeholder="Enter image." required>
                              <div class="valid-feedback">

                              </div>
                          </div><br><br>
                          <div class="col-8">
                              <label for="validationCustom02" class="form-label">Percent OFF% :</label>
                              <input type="text" class="form-control" name="per" id="validationCustom02" placeholder="Enter Percent OFF%" required>
                              <div class="valid-feedback">
                          ...
                          <div class="col-8">
                              ...
                              <input type="text" class="form-control" name="peru" id="validationCustom02" placeholder="Enter Description" required>
                              <div class="valid-feedback">
          ...
          <div class="col-12">
              <input type="submit" id="Touch" class="btn btn-secondary" value="Submit Here" name="register">
          </div>
          </form>
      </div>
      </div>
          ...
          <div class="container">
              <div class="row">
                  <form class="row g-3 needs-validation" action="" method="post" enctype="multipart/form-data">
                      <div class="col-md-6">
                          <label for="validationCustom01" class="form-label">Product Name :</label>
                          <input type="text" class="form-control" name="pnm" id="validationCustom01" required placeholder="Enter Product Name">
                          <div class="valid-feedback">
                              Looks good!
                          </div>
                      </div>
                      <div class="col-md-6">
                          <label for="validationCustom02" class="form-label">Price Name :</label>
                          <input type="text" class="form-control" name="prnm" id="validationCustom02" placeholder="Enter Price Name" required>
                          <div class="valid-feedback">
                      ...
                      <div class="col-md-6">
                          <label for="validationCustom02" class="form-label">Product video :</label>
                          <input type="file" class="form-control" name="image" id="validationCustom02" placeholder="Enter image." required>
                          <div class="valid-feedback">
                      ...
                      <div class="col-8">
                          <label for="validationCustom02" class="form-label">Percent OFF% :</label>
                          <input type="text" class="form-control" name="perm" id="validationCustom02" placeholder="Enter Percent OFF%" required>
                          <div class="valid-feedback">
                      ...
                      <div class="col-8">
                          <label for="validationCustom02" class="form-label">Description :</label>
                          <input type="text" class="form-control" name="perum" id="validationCustom02" placeholder="Enter Description" required>
                          <div class="valid-feedback">
      ...
      <div class="col-12">
          <input type="submit" id="Touch" class="btn btn-secondary" value="Submit Here" name="login">
      </div>
      </form>
      </div>
      </div>
