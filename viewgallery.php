  <?php
    ...
    if (isset($_GET['id'])) {
        $d = $_GET['id'];
        $sql = mysqli_query($conn, "DELETE FROM `gallery_entry` WHERE id='$d'");
        if ($sql) {
    ?>
    ...
    color: #303030;">Cherry</b><br><b style="color:rgba(172, 4, 46, 0.79);">"Where Quality and taste are known Best."</b></div>
      ...
      <div class="max-w-[1390px] mx-auto">
          ...
          <section class="MenuSection" id="menu-id">
              <h1 id="ADD MENU">Your Gallery List</h1>
                      ...
                      <div class="row g-0">
                          ...
                          <div class="col-md-8">
                              <div class="card-body">
                                  ...
                                  <p class="card-text"><small class="text-body-secondary"> <a href="viewgallery.php?id=<?php echo $y['id']; ?>">
