...
<body>
    ...
    <div class="max-w-[1390px] mx-auto">
        ...
        <center>
            <div class="cap">
                <section>
                    ...
                    <img src="nb.webp" style="width:100%;" alt="">
                </section>
                <section class="second-Sec" id="Second-sec-id">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mx-auto second-sec" data-aos="fade-left">
                                <h2><span id="Welcome">Welcome to</span> Our Gallery</h2>
                            ...
                            <div class="col-lg-6 col-md-6 mx-auto second-sec">
                                ...
                                <div class="v1" data-aos="fade-up">
                                    <video src="v3.mp4" loop muted autoplay="autoplay" class="srk" style="margin-left:25%;">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $i = 1;
        $x = mysqli_query($conn, "SELECT * FROM `gallery_entry`");
        while ($y = mysqli_fetch_array($x)) {
        ?>
            <center>
                <!-- <div class="flexa"> -->
                <!-- <div class="copl" style="display: flex;"></div> -->
                <div class="card mb-3" style="max-width: 540px;" data-aos="fade-up">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <?php echo "<video src='$y[productImage]'; controls muted width=150px height=100px loop muted autoplay='autoplay'></video>" ?>
                        </div>
                        <div class="col-md-8" style="margin-top:20%; text-align: justify;">
                            <div class="card-body">
                                <h5 class="card-title">Bake with Cherry</h5>
                                <p class="card-text"><?php echo $y['des']; ?></p>
